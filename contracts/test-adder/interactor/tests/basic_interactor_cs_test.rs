use basic_interactor::{TestAdderInteract, Config};
...
async fn simulator_upgrade_test() {
    let mut basic_interact = TestAdderInteract::new(Config::chain_simulator_config()).await;
...
async fn set_state_cs_test() {
    ...
    let real_chain_interact = TestAdderInteract::new(Config::load_config()).await;
    let simulator_interact = TestAdderInteract::new(Config::chain_simulator_config()).await;
...
async fn set_state_from_file_cs_test() {
    ...
    let mut real_chain_interact = TestAdderInteract::new(Config::load_config()).await;
    let simulator_interact = TestAdderInteract::new(Config::chain_simulator_config()).await;
