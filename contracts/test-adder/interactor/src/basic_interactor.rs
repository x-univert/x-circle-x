...
use test_adder::test_adder_proxy;
...
pub async fn adder_cli() {
    ...
    let mut basic_interact = TestAdderInteract::new(config).await;
...
impl TestAdderInteract {
    ...
    pub async fn deploy(&mut self) {
        let new_address = self
            ...
            .gas(6_000_000)
            .typed(test_adder_proxy::TestAdderProxy)
            .init(0u64)
