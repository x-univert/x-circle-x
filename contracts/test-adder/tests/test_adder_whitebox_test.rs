...
const CODE_PATH: MxscPath = MxscPath::new("mxsc:output/test-adder.mxsc.json");

fn world() -> ScenarioWorld {
    let mut blockchain = ScenarioWorld::new();

    // blockchain.set_current_dir_from_workspace("relative path to your workspace, if applicable");
    blockchain.register_contract(CODE_PATH, test_adder::ContractBuilder);
    blockchain
}
...
fn adder_whitebox() {
    ...
    let new_address = world
        ...
        .whitebox(test_adder::contract_obj, |sc| {
